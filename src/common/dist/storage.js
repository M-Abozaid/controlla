...
var saveVisit_1 = require("./saveVisit");
...
var Storage = /** @class */ (function (_super) {
    ...
    Storage.prototype.updateRuleById = function (ruleId, ruleObj) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.updateOrCreateDoc(this.rulesDB, ruleObj, ruleId)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.getRules()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.rulesDB.get(ruleId)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getQuotaUsage(newRule.id)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.getRules()];
                    case 3:
    ...
    Storage.prototype.closeOpenVisit = function (visit) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dbVisit = this.visits.find(function (v) { return v._id === visit._id; });
                        if (dbVisit.leftTime)
                            return [2 /*return*/];
                        dbVisit.leftTime = new Date();
                        return [4 /*yield*/, saveVisit_1["default"](visit)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, dbVisit];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        allRules = _a.sent();
                        visit = this.getOpenVisit(tab.id);
                        return [2 /*return*/, allRules.filter(function (rule) { return rule.doesMatch(tab, visit); })];
                }
            });
        });
    };
    ...
    Storage.prototype.getQuotaUsage = function (ruleId) {
        return __awaiter(this, void 0, void 0, function () {
            var result, usage, usageDay, newUsage, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        usage = result.docs[0];
                        usageDay = this.__getDailyQuotaDay(usage && usage.day);
                    ...
                    case 3:
                        if (!(usageDay !== usage.day)) return [3 /*break*/, 5];
                        // update usage
                        usage.day = usageDay;
                        usage.activeUsage = 0;
    ...
    Storage.prototype.pauseControl = function () {
        if (this.isPauseAllowed()) {
            localStorage.setItem('isControlPaused', 'true');
        }
    };
    Storage.prototype.resumeControl = function () {
        localStorage.setItem('isControlPaused', 'false');
    };
    Storage.prototype.isPauseAllowed = function () {
        var pauseUsage = storage.getOrCreatePauseUsage();
        return pauseUsage.usage < settings_1["default"].pauseQuota;
    };
    Storage.prototype.incrementPauseUsage = function (increment) {
        if (this.isPauseAllowed()) {
            var pauseControlUsage = this.getOrCreatePauseUsage();
    ...
    Storage.prototype.getOrCreatePauseUsage = function () {
        var pauseControlUsage = localStorage.pauseControlUsage &&
            JSON.parse(localStorage.pauseControlUsage);
        if (pauseControlUsage &&
            this.__getDailyQuotaDay(pauseControlUsage.day) === pauseControlUsage.day) {
            return pauseControlUsage;
        }
        {
            var initialPauseControlUsage = {
    ...
    Storage.prototype.isControlPaused = function () {
        return localStorage.isControlPaused === 'true';
    };
    Storage.prototype.__getDailyQuotaDay = function (usageDay) {
        var today = moment_1["default"]().format('DD-MM-YYYY');
        var yesterday = moment_1["default"]()
            .subtract(1, 'days')
            .format('DD-MM-YYYY');
        var hour = moment_1["default"]().hour();
        if (!usageDay) {
            return hour < settings_1["default"].quotaRenewalHour ? yesterday : today;
        }
        if (usageDay !== today) {
            if (hour >= settings_1["default"].quotaRenewalHour) {
                return today;
            }
            else {
                return yesterday;
    ...
    Storage.prototype.createVisitFromTab = function (tab) {
        return __awaiter(this, void 0, Promise, function () {
            var newVisit, vidId, ytDetails;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newVisit = {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.rulesDB.createIndex({ index: { fields: ['matcher.type'] } })];
                    case 1:
                        _a.sent();

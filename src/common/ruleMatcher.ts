import { Matcher, MatcherType } from './../popup/types/index';

class RuleMatcher{


    matchVideoSnippet(matcher: Matcher, { categoryId, channelTitle, title }: gapi.client.youtube.VideoSnippet): boolean{
   
        return this.matchVideoCategory(matcher, title) || 
    ...
    matchTab(matcher, tab:chrome.tabs.Tab, snippet?:gapi.client.youtube.VideoSnippet): boolean{
